        ...
        <div className="container">
          <div className="datos-abiertos-header">
            ...
            <p className="datos-abiertos-intro">
              ...
              el Concejo Municipal de Guachucal pone a disposición de la ciudadanía los siguientes datasets
          ...
          <div className="licencia-info">
            ...
            <p>
              ...
              la atribución correspondiente al Concejo Municipal de Guachucal.
            </p>
          </div>
          ...
          <div className="contacto-datos">
            ...
            <p>
              ...
              <strong>contacto@concejo.guachucal.gov.co</strong>
            </p>
          </div>
        </div>
      </section>
