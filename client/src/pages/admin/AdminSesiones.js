...
const AdminSesiones = () => {
  ...
  const handleEdit = (sesion) => {
    setFormData({
      ...
      fecha: sesion.fecha || '',
      hora: sesion.hora || '',
      lugar: sesion.lugar || 'Sala de Sesiones del Concejo Municipal',
  ...
  return (
    <div className="admin-sesiones">
      <AdminNavbar title="Gestión de Sesiones del Concejo" />
      <div className="admin-content-wrapper">
          ...
          {showForm && (
            <form className="sesiones-form" onSubmit={handleSubmit}>
              <h2>{editingId ? 'Editar Sesión' : 'Nueva Sesión del Concejo'}</h2>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Sala de Sesiones del Concejo Municipal"
                />
              </div>
